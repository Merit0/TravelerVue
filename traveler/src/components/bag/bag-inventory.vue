...
<style>
 ...
 .bag_frame {
    ...
    border-radius: 10%;
    position: fixed;
    background-image: url('/images/overlays/bag_frame.png');
 ...
 .add_item_slot {
    ...
    background-image: url('/images/homePage_slotImages/item_slot_image.png');
    position: fixed;
 }
 ...
 .add_item_button {
    ...
    background-image: url('/images/homePage_slotImages/plus_button.png');
 }
</style>