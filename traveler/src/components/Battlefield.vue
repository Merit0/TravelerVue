        ...
        <div class="battlefieldOverlay">
            <div class="battleArea">
                ...
                <div class="buttonContainer">
                    <button class="escapeBattle" @click="escape()">Escape</button>
                </div>
                <div class="enemySide">
                    <enemy-tile :enemyShown = "enemyTileShown" :enemyAlive="enemyAlive" v-for="enemy in enemies" :key="enemy.getId()"></enemy-tile>
                </div>
            </div>
...
export default {
    ...
    data() {
        ...
        const enemies: EnemyModel[] = heroStore.hero.getTile().getEnemies();
        let enemyTileShown = true;
        let enemyAlive = true;
        return { heroStore, enemies, enemyTileShown, enemyAlive }
    },
    methods: {
        async escape() {
            this.heroStore.hero.setTile(null);
            return true;
        }
    }
}
