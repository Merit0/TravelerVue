...
export default {
  ...
  data() {
    ...
    const forestCaveLocation: MapLocationModel = locations.find(location => location.name === mapLocationName);
    forestCaveLocation.hero = hero;
    mapLocationStore.buildLocationMap(forestCaveLocation);
